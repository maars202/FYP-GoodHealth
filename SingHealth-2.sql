...
CREATE TABLE `PersonalDetails` (
  ...
  `Covid-19 Vaccination Status` varchar(100) NOT NULL,
  `Date of First Dose` date NOT NULL,
  `Date of Second Dose` date NOT NULL,
  `Vaccination Remarks` varchar(100),
  `Year of Graduation` int(50) NOT NULL,
  `Date of Graduation` varchar(100) NOT NULL,
  `Basic Qualification` varchar(100) NOT NULL,
  `Medical School` varchar(100) NOT NULL,
  `Country of Graduation` varchar(100) NOT NULL,
  `IM Residency Start Date` date NOT NULL,
  `IM Residency End Date` date NOT NULL,
  `SR Residency Programme` varchar(100) NOT NULL,
  `SR Residency Start Date` date NOT NULL,
  `SR Residency End Date` date NOT NULL,
