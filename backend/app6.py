...
class Projects(db.Model):
    ...
    Project_Title = db.Column(db.String(400))
    Project_ID=db.Column(db.String(100))
...
def view():
    ...
    # awards = pd.read_excel(file, sheet_name="Awards", dtype=str)
    # print(awards.columns)
    # awards.columns = ['MCR_No', 'Award_Category', 'Name_of_Award',
    #    'FY_of_Award_Received', 'Date_of_Award_Received',
    #    'Project_ID', 'Column1']

    # awards = awards[['MCR_No', 'Award_Category', 'Name_of_Award',
    #    'FY_of_Award_Received', 'Date_of_Award_Received',
    #    'Project_ID']]
...
#     PMID = db.Column(db.String(100))
    ...
    projects = pd.read_excel(file, sheet_name="Projects", dtype=str)
    print(projects.columns)
    print(len("To increase the proportion of gastroenterology and hepatology patients with decompensated liver cirrhosis receiving who are not nil by mouth (NBM), late night snacks on a weekly basis from 18% to 100% by 12 months in ward 46, SGH ."))
    projects.columns = ['MCR_No', 'Project_Type', 'Project_Title',
       'Project_ID', 'Start_Date', 'End_Date', 'Date_of_QI_Certification',
       'PMID']

    projects = projects[['MCR_No', 'Project_Type', 'Project_Title',
       'Project_ID', 'Start_Date', 'End_Date', 'Date_of_QI_Certification',
       'PMID']]
